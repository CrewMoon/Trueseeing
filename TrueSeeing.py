...
class TrueSeeingApp:
    ...
    def manipulate_input(self, event):
        ...
        if new_input in self.harmless_format_characters:
            self.text_area_p2.tag_config("greenColor",foreground="green")
    ...
    def GUI_choose_encoding_format(self):
        ...
        self.button_choose_encoding_format = tk.Button(self.frame_CEF, 
                                                       ...
                                                       cursor="hand2", 
                                                       text="Select", 
                                                       command=lambda: self.GUI_text_examination(self.encoding_format.get()))
    ...
    def GUI_signature(self):
        ...
        self.algorithm_label = tk.Label(self.frame_S,
                                        font=(self.default_font, 10),
                                        text="We have successfully generate the signature for this text\n"
    ...
    def detect_harmful_characters(self, text):
        ...
        harmful_characters = [char for char in text if char in self.harmful_graphical_characters or char in self.harmful_format_characters]
